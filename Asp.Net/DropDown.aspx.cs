...
namespace ValidationForm
{
    public partial class DropDown : System.Web.UI.Page
    {
        ...
        {
            string connectionString = "Data Source=DESKTOP-QT477Q5; initial catalog=master;integrated security = true;";
            SqlConnection con = new SqlConnection(connectionString);
            SqlCommand command = new SqlCommand("GetBiscuitProducts", con);
